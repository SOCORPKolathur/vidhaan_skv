...
//
//
// Future<Uint8List> generateTimeTablePdf(PdfPageFormat pageFormat,List<AttendancePdfModel> attenancesList, bool isStudent) async {
//
...
// }
//
// class TimeTableModelforPdfPrint{
//
//   TimeTableModelforPdfPrint({required this.title, required this.attenancesList});
//   String? title;
