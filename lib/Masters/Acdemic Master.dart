...
class AcademicMaster extends StatefulWidget {
  const AcademicMaster({Key? key}) : super(key: key);

  @override
  State<AcademicMaster> createState() => _AcademicMasterState();
}

class _AcademicMasterState extends State<AcademicMaster> {
  ...
  getorderno() async {
    var document = await  FirebaseFirestore.instance.collection("AcademicMaster").get();
    setState(() {
  ...
  Successdialog(){
    ...
    return AwesomeDialog(
      ...
      desc: 'Academic Year - ${name.text} is been added',
      ...
      children: [
        Padding(
          ...
          child: Container(child: Padding(
            ...
            child: Text("Acdemic  Master",style: GoogleFonts.poppins(fontSize: width/75.888888889,fontWeight: FontWeight.bold),),
          ),
            //color: Colors.white,
            width: width/1.050,
            height: height/8.212,
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Container(child: TextField(
                              ...
                              decoration: InputDecoration(contentPadding: EdgeInsets.only(left: height/136.6,bottom: height/81.375),
                                border: InputBorder.none,
                              ),
                            ),
                              width: width/3.902,
